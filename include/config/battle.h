...
#define B_FLAG_AI_VS_AI_BATTLE      FLAG_AI_VS_AI_BATTLE    // 0x25; If this flag is set, the player's mons will be controlled by the ai next battles.
#define B_FLAG_DYNAMAX_BATTLE       FLAG_DYNAMAX_BATTLE     // 0x26; If this flag is set, the ability to Dynamax in battle is enabled for all trainers.
#define B_FLAG_TERA_ORB_CHARGED     FLAG_TERA_ORB_CHARGED   // 0x27; If this flag is set, the Tera Orb is charged. It is automatically set upon healing and cleared upon Terastallizing once configured.
#define B_FLAG_TERA_ORB_NO_COST     FLAG_TERA_ORB_NO_COST   // 0x28; If this flag is set, the Tera Orb does not use up its charge upon Terastallization. In S/V, this occurs after an event with Terapagos.
...
// Sky Battles
#define B_FLAG_SKY_BATTLE                 FLAG_SKY_BATTLE    // 0x29; If this flag has a value, the player will be able to engage in scripted Sky Battles.
#define B_VAR_SKY_BATTLE                  VAR_SKY_BATTLE     // 0x4091; If this var has a value, the game will remember the positions of Pokémon used in Sky Battles.
