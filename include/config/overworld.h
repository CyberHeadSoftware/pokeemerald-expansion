...
#define OW_FLAG_PAUSE_TIME          FLAG_PAUSE_TIME      // 0x2B; If this flag is set and OW_USE_FAKE_RTC is enabled, seconds on the in-game clock will not advance.
#define OW_FLAG_NO_ENCOUNTER        FLAG_NO_ENCOUNTER    // 0x2C; If this flag is set, wild encounters will be disabled.
#define OW_FLAG_NO_TRAINER_SEE      FLAG_NO_TRAINER_SEE  // 0x2D; If this flag is set, trainers will not battle the player unless they're talked to.
#define OW_FLAG_NO_COLLISION        FLAG_NO_COLLISION    // 0x2E; If this flag is set, the player will be able to walk over tiles with collision. Mainly intended for debugging purposes.
