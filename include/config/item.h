...
#define I_EXP_SHARE_FLAG        FLAG_EXP_SHARE  // 0x2C; If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
...
#define I_VAR_LAST_REPEL_LURE_USED  VAR_LAST_REPEL_LURE_USE  // 0x409D; If this var has been assigned, last Repel/Lure used will be saved and the player will get prompted with the vanilla repel YES/NO option, unless I_REPEL_LURE_MENU is set to TRUE.
