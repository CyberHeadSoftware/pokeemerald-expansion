...
#define P_FLAG_FORCE_SHINY      FLAG_FORCE_SHINY        // 0x2F; If this flag is set, all wild and gift Pokémon will forced into being Shiny.
#define P_FLAG_FORCE_NO_SHINY   FLAG_FORCE_NO_SHINY     // 0x30; If this flag is set, all wild and gift Pokémon will forced into NOT being Shiny.
