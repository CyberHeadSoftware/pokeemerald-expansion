...
#define VAR_STARTING_STATUS                              0x404E // If this var has a value, assigning a STATUS_FIELD_xx_TERRAIN to it before battle causes the battle to start with that terrain active.
...
#define VAR_WILD_AI_FLAGS                                0x408B // If not 0, you can use this var to add to default wild AI flags. NOT usable with flags above (1 << 15)
#define VAR_LITTLEROOT_HOUSES_STATE_BRENDAN              0x408C
#define VAR_LITTLEROOT_RIVAL_STATE                       0x408D
#define VAR_BOARD_BRINEY_BOAT_STATE                      0x408E
#define VAR_DEVON_CORP_3F_STATE                          0x408F
#define VAR_BRINEY_HOUSE_STATE                           0x4090
#define VAR_SKY_BATTLE                               	 0x4091 // If this var has a value, the game will remember the positions of Pokémon used in Sky Battles.
...
#define VAR_LAST_REPEL		                             0x409B // If this var has been assigned, last Repel/Lure used will be saved and the player will get prompted with the vanilla repel YES/NO option
