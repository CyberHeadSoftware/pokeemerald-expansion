...
#define VAR_STARTING_STATUS                              0x404E // Assigning a STATUS_FIELD_xx_TERRAIN to this var before battle causes the battle to start with that terrain active.
...
#define VAR_STARTING_STATUS_TIMER                        0x4083 // If this var has a value greater or equal than 1 field terrains will last that number of turns, otherwise they will last until they're overwritten.
...
#define VAR_WILD_AI_FLAGS                                0x408B // This var will add to default wild AI flags. NOT usable with flags above (1 << 15)
#define VAR_LITTLEROOT_HOUSES_STATE_BRENDAN              0x408C
#define VAR_LITTLEROOT_RIVAL_STATE                       0x408D
#define VAR_BOARD_BRINEY_BOAT_STATE                      0x408E
#define VAR_DEVON_CORP_3F_STATE                          0x408F
#define VAR_BRINEY_HOUSE_STATE                           0x4090
#define VAR_DIFFICULTY                                   0x4091 // This var will control which difficulty version of a Trainer is loaded. This should be manually set by the developer using Script_SetDifficulty AFTER NewGameInitData has run.
...
#define VAR_SKY_BATTLE                                   0x409B // This var is used to remember the position of Pokémon used in sky battles
#define VAR_ELITE_4_STATE                                0x409C
#define VAR_LAST_REPEL_LURE_USE                         0x409D // The last Repel/Lure used will be saved and the player will get prompted with the vanilla repel YES/NO option, unless I_REPEL_LURE_MENU is set to TRUE.
